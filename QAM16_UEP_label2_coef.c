...
printf("column = %d; row = %d\n", n, rc);
    ...
    while (error_block < 50/*100*/) {
        ...
        printf("coef . txt errorblock = %d num %d \n",error_block,num);
        error1 = 0;
        error2 = 0;
        ...
        totalerror2 += error2;
        FILE *outfp2; 
        outfp2 = fopen("QAM16_UEP_label2_LEVEL2_totalerror_alpha=1.04527.txt","a");
    ...
    FILE *outfp1; 
        outfp1 = fopen("QAM16_UEP_label2_LEVEL2_coef_alpha=1.04527.txt","a");
